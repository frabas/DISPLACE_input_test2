  ...
  for (S in 1:2){
   ...
   for (namefile in c("vesselsspe_fgrounds_quarter", "vesselsspe_freq_fgrounds_quarter", "vesselsspe_harbours_quarter", "vesselsspe_freq_harbours_quarter")){
     ...
     for (Q in 1:4){
      ...
      write.table(dd, file=paste("C:\\Users\\fbas\\Documents\\GitHub\\DISPLACE_input_test2\\vesselsspe_fake\\","vesselsspe_features_quarter",Q,".dat", sep=""), sep="|", col.names=TRUE, row.names=FALSE, sep=" ", quote=FALSE)
     } 
